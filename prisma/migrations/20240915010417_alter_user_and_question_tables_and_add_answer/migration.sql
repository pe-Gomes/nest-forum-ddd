/*
  ...
  - You are about to drop the `quesitons` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "quesitons" DROP CONSTRAINT "quesitons_author_id_fkey";

-- AlterTable
ALTER TABLE "users" ADD COLUMN     "role" "UserRole" NOT NULL DEFAULT 'STUDENT';

-- DropTable
DROP TABLE "quesitons";
